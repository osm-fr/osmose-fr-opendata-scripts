. $(dirname $0)/config.sh
OUT=/home/cquest/osmose/insee_poi_near_building-france.xml
...
select format('<error class=\"60\" subclass=\"1\"><location lat=\"%s\" lon=\"%s\" /><text lang=\"en\" value=\"%s=%s à %sm du bâtiment\" /><node id=\"%s\"></node></error>',
